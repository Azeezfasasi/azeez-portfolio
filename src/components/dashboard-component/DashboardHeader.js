      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="flex items-center gap-3 bg-gray-800 rounded-md p-1">
              <Image src="/img/azeezlogo2.png" alt="Rayob Logo" width={160} height={40} className="w-14 md:w-[100px] block rounded-lg p-1" />
            </Link>
          </div>
