...
const categories = ["All", "UI/UX", "Backend / API Projects", "Full Stack Applications", "API Integration Projects", "Authentication & Security Projects", "Data-Driven Applications"];
