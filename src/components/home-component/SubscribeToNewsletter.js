          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-gray-600">
                Subscribe to my newsletter and get the latest news, updates, and exclusive offers delivered to your inbox.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Unsubscribe anytime, I respect your privacy</p>
                </div>
              </div>
            </div>
          </div>
