...
export default function RequestQuote() {
  ...
  return (
    <section className="bg-[url('/img/headerbg2.png')] bg-cover bg-center relative py-16" id="request-quote">
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto">
            Get in touch with me to discuss your project requirements and receive a detailed, no-obligation estimate.
          </p>
        </div>
