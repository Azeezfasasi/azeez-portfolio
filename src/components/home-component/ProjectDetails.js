      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-4">
            {project.clientWebsiteLink && (
              <a 
                href={project.clientWebsiteLink} 
                target="_blank" 
                rel="noopener noreferrer"
                className="group bg-white rounded-xl p-5 shadow-sm border border-gray-200 hover:shadow-lg hover:border-cyan-300 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer block"
              >
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 bg-blue-100 rounded-lg group-hover:bg-cyan-200 transition-colors">
                    <svg className="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M11 3a1 1 0 10-2 0v1a1 1 0 102 0V3zM15.657 5.343a1 1 0 00-1.414-1.414l-.707.707a1 1 0 001.414 1.414l.707-.707zM18 10a1 1 0 01-1 1h-1a1 1 0 110-2h1a1 1 0 011 1zM15.657 14.657a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414l.707.707zM11 17a1 1 0 102 0v-1a1 1 0 10-2 0v1zM5.343 15.657a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414l-.707.707zM5 10a1 1 0 01-1-1V8a1 1 0 012 0v1a1 1 0 01-1 1zM5.343 5.343a1 1 0 00-1.414 1.414l.707.707a1 1 0 001.414-1.414L5.343 5.343z" />
                    </svg>
                  </div>
                  <p className="text-xs text-gray-600 font-bold uppercase tracking-widest">Client Website</p>
                </div>
                <p className="text-cyan-600 font-semibold ml-9 hover:text-cyan-700 transition-colors break-all text-sm line-clamp-2">
                  {project.clientWebsiteLink.replace(/^https?:\/\//, '')}
                </p>
              </a>
            )}
        ...
        <div className="bg-gradient-to-r from-blue-800 via-blue-800 to-blue-900 rounded-2xl p-8 shadow-xl text-white mb-8 border border-blue-500/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h4 className="font-bold text-blue-100 uppercase text-sm mb-4 tracking-widest">🛠️ Infrastructure & Services</h4>
              <div className="flex flex-wrap gap-2">
                {Array.isArray(project.materialsUsed) && project.materialsUsed.length > 0 ? (
                  ...
                  <p className="text-blue-100 italic">Infrastructure & Services</p>
                )}
              </div>
            </div>
          </div>
