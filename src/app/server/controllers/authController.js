...
const SENDER_EMAIL = process.env.BREVO_SENDER_EMAIL || "fas.azeez@gmail.com";
const SENDER_NAME = process.env.BREVO_SENDER_NAME || "Azeez Portfolio";
  ...
  try {
    ...
    try {
      await transporter.sendMail({
        to: email,
        subject: "Email Verification - Azeez Portfolio",
        html: `<h2>Welcome to Azeez Portfolio</h2>
...
export const forgotPassword = async (req) => {
  try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>We received a request to reset your password for your Azeez Portfolio account.</p>
              ...
              <hr>
              <p><small>Best regards,<br>Azeez Portfolio</small></p>
            </div>
            <div class="footer">
              <p>© 2026 Azeez Portfolio. All rights reserved.</p>
            </div>
          </div>
        </body>
      </html>
    ...
    try {
      await sendEmailViaBrevo(email, "Password Reset - Azeez Portfolio", htmlContent);
