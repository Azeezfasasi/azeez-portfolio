...
const DEFAULT_MILESTONES = {
  milestones: [
    { year: '2010', title: 'Company Founded', description: 'Azeez Portfolio was established to deliver quality engineering solutions across industrial and commercial sectors.', order: 0, active: true },
