  ...
  try {
    ...
    try {
      const emailResult = await sendEmailViaBrevo({
        to: email,
        subject: 'Welcome to Azeez Portfolio Newsletter',
        htmlContent: `
          <!DOCTYPE html>
          <html>
            <head>
            ...
            <body>
              <div class="container">
                <div class="header">
                  <h1>Welcome to Azeez Portfolio!</h1>
                </div>
                <div class="content">
                  <p>Hi ${firstName || 'there'},</p>
                  <p>Thank you for subscribing to our newsletter! We're excited to share the latest updates, insights, and innovations from Azeez Portfolio.</p>
                  <p>You'll receive:</p>
                  <ul>
                  ...
                  <p>Best regards,<br/>Azeez Portfolio</p>
                </div>
                <div class="footer">
                  <p>© 2025 Azeez Portfolio. All rights reserved.</p>
        ...
        `,
        textContent: `Welcome to Azeez Portfolio Newsletter!

Hi ${firstName || 'there'},

Thank you for subscribing to our newsletter! We're excited to share the latest updates, insights, and innovations from Azeez Portfolio.
...
To unsubscribe: ${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/api/newsletter/unsubscribe?email=${email}
        `,
        senderEmail: process.env.BREVO_SENDER_EMAIL || 'fas.azeez@gmail.com',
        senderName: process.env.BREVO_SENDER_NAME || 'Azeez Portfolio',
